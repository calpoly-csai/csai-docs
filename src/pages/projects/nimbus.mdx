...
<LibraryPill name="Flask" invertOnDark={true} icon={flaskIcon} link={libraryLinks.python.FLASK} />
<LibraryPill name="SQL Alchemy" icon={sqlAlchemyIcon} link={libraryLinks.python.SQLALCHEMY} />
</div>
...
<Flex>
<LibraryPill name="Scikit Learn" icon={sklearnIcon} link={libraryLinks.python.SKLEARN} />
<LibraryPill name="Tensorflow" icon={tensorflowIcon} link={libraryLinks.python.TENSORFLOW} />
</Flex>
