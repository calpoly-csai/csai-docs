...
An interactive virtual tour of Cal Poly using Computer Vision and 3D web technology.
...
<InlineFlex>
  <Project
    ...
    generalLink="https://docs.google.com/document/d/1KFxSek3xubSyxoo7UeFDOJGK2J3Jbt1TP-mtxb-HVr4/"
  />
  <Project
    title="Argo App Prototype"
    description="A simple tour example. Requires a powerful machine. Works best in Safari"
    githubLink="https://github.com/calpoly-csai/virtual-tour-concept"
    liveLink="https://sleepy-mclean-e6f76f.netlify.app/"
  />
</InlineFlex>
