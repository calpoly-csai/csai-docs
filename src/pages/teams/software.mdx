...
- Stick to pep8 styling (run `pycodestyle filename`)
...
=======
We don't want to be making actual calls to the database when we're testing Otherwiseher logic, after all.	
>>>>>>> b399938... Add some testing/style guidelines to software page
